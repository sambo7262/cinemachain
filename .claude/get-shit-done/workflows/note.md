...
- **Global scope**: `/Users/Oreo/Projects/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/Oreo/Projects/.claude/notes/`)
...
2. Glob `/Users/Oreo/Projects/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/Oreo/Projects/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/Oreo/Projects/.claude/notes/` — works in any directory
