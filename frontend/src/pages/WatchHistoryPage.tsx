...
const SORT_OPTIONS = [
  ...
  { value: "rt_audience:desc",     label: "RT Audience (highest)" },
  { value: "imdb:desc",            label: "IMDb Rating (highest)" },
  { value: "metacritic:desc",      label: "Metacritic (highest)" },
  { value: "letterboxd:desc",      label: "Letterboxd (highest)" },
  { value: "mdb_avg:desc",         label: "MDB Average (highest)" },
