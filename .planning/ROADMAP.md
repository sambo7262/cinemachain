...
| 22. Filmography Refresh Gap | 4/4 | Complete | 2026-05-29 |
...
- [x] 22-04-PLAN.md — Live NAS deploy via make rebuild + 4-part human verification: Meryl Streep DWP2, Settings button completes, filmography_fetched_at populated, no fresh-actor latency regression
