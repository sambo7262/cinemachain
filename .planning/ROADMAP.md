...
- [ ] **Phase 3: Movie Game** — Complete actor-chain game loop with session state, eligibility panels, and Radarr request submission (03-13 PARTIAL PASS 2026-03-15 — 03-14/03-15 gap-closure + 03-16 final verification pending)
...
- [ ] 03-16-PLAN.md — Wave 9 (gap-closure): Final re-verification checkpoint — all GAME requirements
...
| 3. Movie Game | 13/16 | In Progress|  |
...
*Last updated: 2026-03-15 — 03-14/03-15 gap-closure plans added; 03-16 final verification; Phase 3 close pending*
