...
- [ ] **Phase 3: Movie Game** — Complete actor-chain game loop with session state, eligibility panels, and Radarr request submission (verification FAILED 2026-03-15 — gap-closure plans 03-11/03-12/03-13 pending)
...
**Plans:** 12 plans (9 executed; 03-10 FAILED; 03-11, 03-12, 03-13 gap-closure pending)
...
- [ ] 03-11-PLAN.md — Wave 6 (gap-closure): eligible-movies on-demand TMDB fetch + Makefile rebuild target
- [ ] 03-12-PLAN.md — Wave 6 (gap-closure): GameSession pause/resume toggle + GameLobby end-session refetch
- [ ] 03-13-PLAN.md — Wave 7 (gap-closure): Re-verification checkpoint — run make rebuild, full game loop E2E
...
| 3. Movie Game | 9/12 | Blocked — gap-closure in progress |  |
...
*Last updated: 2026-03-15 — Phase 3 gap-closure plans 03-11/03-12/03-13 added (4 defects from 03-10 checkpoint)*
