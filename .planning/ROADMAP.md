...
| v2.0.2 | Phase 23 | Smart Metadata Backfill — stop wasteful nightly re-tries on confirmed-empty fields; align DB Health audit semantics with sentinel pattern | Planned |
