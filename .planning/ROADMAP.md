...
- [ ] **Phase 3: Movie Game** — Complete actor-chain game loop with session state, eligibility panels, and Radarr request submission (03-13 PARTIAL PASS 2026-03-15 — GAME-01 session lifecycle still broken; 03-14 gap-closure pending)
...
- [ ] 03-14-PLAN.md — Wave 8 (gap-closure): Fix GAME-01 session lifecycle (end-session banner clear + new-session start) + re-verify GAME-04/07
...
| 3. Movie Game | 12/14 | In Progress|  |
...
*Last updated: 2026-03-15 — 03-13 partial pass; 03-14 gap-closure plan added for GAME-01 session lifecycle*
